            ...
            <main className="h-screen w-screen overflow-hidden bg-black/15 flex justify-end items-center sm:items-stretch relative">
                ...
                <div data-test="barra-lateral" className={`relative h-auto sm:h-full w-full sm:w-[85%] md:w-[70%] lg:w-[60%] xl:w-[50%] 2xl:max-w-2xl
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-3 sm:mb-4 lg:mb-2">
                            <h1 className="text-xs sm:text-sm md:text-base lg:text-xs font-bold text-gray-100 font-inter">
                                <div className="flex flex-row items-center gap-5 bg-white/50 pl-1 pr-1 rounded-md w-fit h-fit">
                                    <span className="text-[26px] sm:text-[28px] md:text-[30px] lg:text-[24px] text-gray-100">MURAL - IFRO</span>
                                </div>
                        ...
                        <h1 data-test="evento-titulo" className="text-gray-100 text-3xl sm:text-4xl md:text-5xl lg:text-3xl font-bold mb-4 sm:mb-6 md:mb-8 lg:mb-3 font-inter leading-tight">
                            {eventoAtual.titulo}
                        </h1>

                        <div className="flex flex-col gap-2 sm:gap-2.5 md:gap-3 lg:gap-1.5 text-gray-200 text-sm sm:text-base md:text-lg lg:text-base">
                                ...
                                <div className="flex flex-wrap gap-1.5 sm:gap-2" data-test="evento-tags">
                                    {eventoAtual.tags.map((tag: string, index: number) => (
                                        <span
                                            ...
                                            className="font-inter bg-white/20 px-2 py-0.5 sm:px-2.5 sm:py-1 rounded text-sm sm:text-base md:text-lg lg:text-base"
                                        >
                                            {tag.toLowerCase()}
                                        </span>
                                    ))}
                    ...
                    <div className={`flex-1 flex flex-col justify-center items-center
                        ...
                        <div className="bg-white/10 rounded-lg 2xl:rounded-lg p-3 sm:p-4 md:p-5 2xl:p-4 w-full">
                            <p data-test="evento-descricao" className="text-gray-300 font-inter text-sm sm:text-base md:text-lg lg:text-xl 2xl:text-lg leading-relaxed line-clamp-6 sm:line-clamp-7 md:line-clamp-8 lg:line-clamp-10 2xl:line-clamp-[15] text-center">
                    ...
                    { /* LOGO DO FSLAB */}
                    <div className="absolute bottom-4 left-4 sm:bottom-6 sm:left-6 md:bottom-8 md:left-8 lg:bottom-10 lg:left-10 xl:bottom-12 xl:left-12 2xl:bottom-10 2xl:left-10">
                        <img src="/logo_fslab.svg" alt="Logo FSLab" className="h-10 w-auto sm:h-12 md:h-14 lg:h-10 xl:h-12 2xl:h-14" />
                    </div>
